...
-- games where both roster slots resolve to a registered user (0044 +
...
-- Worker is the resulting list of names (user_recommended_opponents, 0046). No
-- endpoint selects from this table, and none should: see docs/api-reference.md
-- and the note on 0046.
--
