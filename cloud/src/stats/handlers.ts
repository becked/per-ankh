...
//
// The first four resolve corpus → check cache → compute on miss → return the
// payload. /stats/players is not a bundle at all — it counts games played per
// user straight out of D1, uncached — and shares this file for the corpus it
// reads rather than for the shape it returns. /home-summary is a trimmed,
// public projection of /stats' cached entry that never computes one.
//
