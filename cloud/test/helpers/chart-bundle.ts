// Canonicalize a stats payload — a chart bundle or a records bundle — so two
// runs over the same fixture compare equal.
//
...
//
// And a few fields carry per-run identifiers: the bundle's save_dates repeats
// each game's nanoid, and the records payload is full of them — every row names
// a game_id and recordGames is *keyed* by one. The caller supplies the mapping
