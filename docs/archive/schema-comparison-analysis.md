...
**Prospector** — No dedicated table. Tribe interactions appear in events (TRIBE*DIPLOMACY, TRIBE_CONTACT, MEMORYTRIBE*\* event types).
...
- Event types include both MemoryData events (MEMORYPLAYER*\*, MEMORYTRIBE*\_, MEMORYCHARACTER\_\_) and LogData events (TECH_DISCOVERED, CITY_FOUNDED, LAW_ADOPTED, etc.)
...
_Generated from analysis of per-ankh schema v2.13.0 (docs/schema.sql) and prospector production database (49 matches, schema migrations 1.0.0–6). February 2026._
