...
- [ ] Add index on xml*id where beneficial: `CREATE INDEX idx*{table}\_xml_id ON {table}(match_id, xml_id)`
...
**Phase 2: High Priority (Milestone 1)** 7. Complete DELETE cascade order 8. Move progress reporting to core 9. Implement ZIP security measures 10. Add concurrency control

**Phase 3: Medium Priority (Milestone 2-3)** 11. Schema initialization 12. Post-import validation 13. Batch insert optimization 14. Consistent parsing helpers 15. Enhanced error messages

**Phase 4: Low Priority (Milestone 5-6)** 16. Import provenance tracking 17. Test fixture creation 18. Fuzz testing
