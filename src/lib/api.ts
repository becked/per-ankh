...
export const api = {
	...
	getGamesList: (collectionId?: number | null) =>
		invoke<GameInfo[]>("get_games_list", {
			collectionId: collectionId ?? null,
		}),
	 ...
	 */
	getPlayerDebugData: () => invoke<PlayerDebugRow[]>("get_player_debug_data"),

	/**
	 * Get match data for debugging.
	 * Returns basic info about all matches in the database.
	 */
	getMatchDebugData: () => invoke<MatchDebugRow[]>("get_match_debug_data"),
	 ...
	 */
	importDirectory: () => invoke<string>("import_directory_cmd"),
	 ...
	 */
	getKnownOnlineIds: () => invoke<KnownOnlineId[]>("get_known_online_ids"),
