<div class="space-y-3 text-sm leading-relaxed text-tan">
	<p>
		Per Ankh is a fan-made tool for the video game &ldquo;Old World.&rdquo; It
		is not affiliated with Mohawk Games, the developer, or Hooded Horse, the
		publisher.
	</p>
	<p>
