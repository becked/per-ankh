...
const KNOWN_TECH_SPRITES = new Set([
	...
	"TECH_DRAMA",
	"TECH_EBONY",
	"TECH_ECONOMIC_REFORM",
	"TECH_EXOTIC_FUR",
	"TECH_FISCAL_POLICY",
	"TECH_FORESTRY",
	"TECH_HUSBANDRY",
	"TECH_HYDRAULICS",
	"TECH_INDUSTRIAL_PROGRESS",
...
const KNOWN_UNIT_SPRITES = new Set([
	...
	"UNIT_DMT_WARRIOR",
	"UNIT_DROMON",
	"UNIT_ELITE_AMAZON_CAVALRY",
	"UNIT_ELITE_CLUBTHROWER",
	"UNIT_ELITE_GAESATA",
	"UNIT_ELITE_HUSCARL",
	"UNIT_ELITE_JAVELINEER",
	"UNIT_ELITE_LIBYAN_CAVALRY",
	"UNIT_ELITE_MARAUDER",
	"UNIT_ELITE_NOMAD_MARAUDER",
	"UNIT_ELITE_NOMAD_SKIRMISHER",
	"UNIT_ELITE_NOMAD_WARLORD",
	"UNIT_ELITE_PELTAST",
	...
	"UNIT_MARAUDER",
	"UNIT_MEROITIC_ARCHER",
	"UNIT_MILITIA",
	"UNIT_NAPATAN_ARCHER",
	"UNIT_NOMAD_MARAUDER",
	"UNIT_NOMAD_SKIRMISHER",
	"UNIT_NOMAD_WARLORD",
	"UNIT_ONAGER",
	"UNIT_PALTON_CAVALRY",
	"UNIT_PELTAST",
...
function resolveTechSprite(
	...
	if (KNOWN_TECH_SPRITES.has(tech))
	...
	if (KNOWN_UNIT_SPRITES.has(unitName))
	...
	if (withoutNation !== tech) {
		...
		if (KNOWN_UNIT_SPRITES.has(unitFallback))
